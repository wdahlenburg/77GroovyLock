...
case "da":
			...
			if (translatedesc=='tropical storm') { document.getElementById("desc").innerHTML='Tropisk Storm'; }

			if (translatedesc=='hurricane') { document.getElementById("desc").innerHTML='Tornado'; }

			if (translatedesc=='severe thunderstorms') { document.getElementById("desc").innerHTML='Kraftig Regn'; }

			if (translatedesc=='thunderstorms') { document.getElementById("desc").innerHTML='Torden'; }

			if (translatedesc=='mixed rain and snow') { document.getElementById("desc").innerHTML='Regn og Sne'; }

			if (translatedesc=='mixed rain and sleet') { document.getElementById("desc").innerHTML='Regn og Slud'; }

			if (translatedesc=='mixed snow and sleet') { document.getElementById("desc").innerHTML='Sne og Sludn'; }

			if (translatedesc=='freezing drizzle') { document.getElementById("desc").innerHTML='Frost T&aring;ge Regn'; }

			if (translatedesc=='drizzle') { document.getElementById("desc").innerHTML='T&aring;ge Regn'; }

			if (translatedesc=='freezing rain') { document.getElementById("desc").innerHTML='Isslag'; }

			if (translatedesc=='showers') { document.getElementById("desc").innerHTML='Regnbyger'; }

			if (translatedesc=='snow flurries') { document.getElementById("desc").innerHTML='Sne Storm'; }

			if (translatedesc=='light snow showers') { document.getElementById("desc").innerHTML='Let Snefald'; }

			if (translatedesc=='light snow grains') { document.getElementById("desc").innerHTML='Let Snefald'; }

			if (translatedesc=='blowing snow') { document.getElementById("desc").innerHTML='Bl&aelig;sende Snefald'; }

			if (translatedesc=='snow') { document.getElementById("desc").innerHTML='Sne'; }

			if (translatedesc=='hail') { document.getElementById("desc").innerHTML='Hagl'; }

			if (translatedesc=='sleet') { document.getElementById("desc").innerHTML='Slud'; }

			if (translatedesc=='dust') { document.getElementById("desc").innerHTML='St&oslash;vet'; }

			if (translatedesc=='foggy') { document.getElementById("desc").innerHTML='T&aring;get'; }

			if (translatedesc=='haze') { document.getElementById("desc").innerHTML='Diset'; }

			if (translatedesc=='smoky') { document.getElementById("desc").innerHTML='Diset'; }

			if (translatedesc=='blustery') { document.getElementById("desc").innerHTML='Stormende'; }

			if (translatedesc=='windy') { document.getElementById("desc").innerHTML='Bl&aelig;sende'; }

			if (translatedesc=='cold') { document.getElementById("desc").innerHTML='Koldt'; }

			if (translatedesc=='cloudy') { document.getElementById("desc").innerHTML='Skyet'; }

			if (translatedesc=='mostly cloudy') { document.getElementById("desc").innerHTML='Mest Skyet'; }

			if (translatedesc=='partly cloudy') { document.getElementById("desc").innerHTML='Delvis skyet'; }

			if (translatedesc=='clear') { document.getElementById("desc").innerHTML='Klart'; }

			if (translatedesc=='sunny') { document.getElementById("desc").innerHTML='Solrigt'; }

			if (translatedesc=='fair') { document.getElementById("desc").innerHTML='KLart'; }

			if (translatedesc=='mixed rain and hail') { document.getElementById("desc").innerHTML='Regn og Hagl'; }

			if (translatedesc=='hot') { document.getElementById("desc").innerHTML='Varmt'; }

			if (translatedesc=='isolated thunderstorms') { document.getElementById("desc").innerHTML='Enkelte tordenbyger'; }

			if (translatedesc=='scattered thunderstorms') { document.getElementById("desc").innerHTML='Spredte Tordenbyger'; }

			if (translatedesc=='scattered showers') { document.getElementById("desc").innerHTML='Enkelte byger'; }

			if (translatedesc=='heavy snow') { document.getElementById("desc").innerHTML='St&AElig;rkt Snefald'; }

			if (translatedesc=='scattered snow showers') { document.getElementById("desc").innerHTML='Spredte Snebyger'; }

			if (translatedesc=='partly cloudy') { document.getElementById("desc").innerHTML='Delvis Overskyet'; }

			if (translatedesc=='thundershowers') { document.getElementById("desc").innerHTML='Torden'; }

			if (translatedesc=='snow showers') { document.getElementById("desc").innerHTML='Snebyger'; }

			if (translatedesc=='isolated thundershowers') { document.getElementById("desc").innerHTML='Enkelte Tordenbyger'; }

			if (translatedesc=='light rain shower') { document.getElementById("desc").innerHTML='Lette Regnbyger'; }

			if (translatedesc=='not available') { document.getElementById("desc").innerHTML='Ingen Info'; }

			if (translatedesc=='showers in the vicinity') { document.getElementById("desc").innerHTML='Regnbyger'; }

			if (translatedesc=='partly sunny') { document.getElementById("desc").innerHTML='Delvis Sol'; }

			if (translatedesc=='ground fog') { document.getElementById("desc").innerHTML='T&aring;get'; }

			if (translatedesc=='light drizzle') { document.getElementById("desc").innerHTML='Sm&aring; Regn'; }

			if (translatedesc=='light rain') { document.getElementById("desc").innerHTML='Let Regn'; }

			if (translatedesc=='mist') { document.getElementById("desc").innerHTML='T&aring;ge'; }

			if (translatedesc=='fog') { document.getElementById("desc").innerHTML='T&aring;ge'; }

			if (translatedesc=='rain') { document.getElementById("desc").innerHTML='Regn'; }

			if (translatedesc=='rain shower') { document.getElementById("desc").innerHTML='Regnbyger'; }

			if (translatedesc=='severe thunderstorm/windy') { document.getElementById("desc").innerHTML='Kraftig Vind'; }
...
case "tr":
			...
			if (translatedesc=='heavy rain') { document.getElementById("desc").innerHTML='Çok Yağmurlu'; }
			...
			if (translatedesc=='mostly sunny') { document.getElementById("desc").innerHTML='Çok Güneşli';	  }

			if (translatedesc=='partly sunny') { document.getElementById("desc").innerHTML='Hafif Güneşli';   }
			...
			if (translatedesc=='partly sunny with showers') { document.getElementById("desc").innerHTML='Hafif Güneşli Yağmur';	 }
			...
			if (translatedesc=='mostly cloudy with thunder showers') { document.getElementById("desc").innerHTML='Gök Gürültülü Bulutlu';	  }

			if (translatedesc=='partly sunny with thunder showers') { document.getElementById("desc").innerHTML='Gök Gürültülü Güneşli';	}
			...
			if (translatedesc=='partly sunny with flurries') { document.getElementById("desc").innerHTML='Hafif Hüneşli Esintili';	  }
			...
			if (translatedesc=='mostly clear') { document.getElementById("desc").innerHTML='Çok Açık';	}
			...
			if (translatedesc=='partly cloudy with showers') { document.getElementById("desc").innerHTML='Parçalı Bulutlu Sağanak'; }

			if (translatedesc=='mostly cloudy with showers') { document.getElementById("desc").innerHTML='Çok Bulutlu Sağanak';	  }

			if (translatedesc=='party cloudy with thunder showers') { document.getElementById("desc").innerHTML='Parçalı Bulutlu Gök Gürültülü';	 }
			...
			if (translatedesc=='blowing snow') { document.getElementById("desc").innerHTML='Rüzgarlı Kar'; }
			...
			if (translatedesc=='scattered thunderstorms') { document.getElementById("desc").innerHTML='Dağınık Gök Gürültülü';    }

			if (translatedesc=='scattered showers') { document.getElementById("desc").innerHTML='Dağınık Yağmurlu';  }

			if (translatedesc=='scattered snow showers') { document.getElementById("desc").innerHTML='Dağınık Kar Yağışlı';    }

			if (translatedesc=='light rain with thunder') { document.getElementById("desc").innerHTML='Hafif Yağmurlu Gök Gürültülü';    }

			if (translatedesc=='not available') { document.getElementById("desc").innerHTML='Veri Yok';    }

			if (translatedesc=='drifting snow/windy') { document.getElementById("desc").innerHTML='Karlı Savurgan Rüzgar';	}

			if (translatedesc=='light rain shower') { document.getElementById("desc").innerHTML='Hafif Sağanak Yağmurlu';	  }
